...
*/
function processV1Request (request: Request, response: Response) {
  ...
  function sendGoogleResponse (responseToUser: any) {
...
*/
function processV2Request (request: Request, response: Response) {
  ...
  const actionHandlers: any = {
    ...
    "input.eth": () => {
      sendResponse("What up. This is another test!");
    },
    // Default handler for unknown or undefined actions
    "default": () => {
      const responseToUser = {
